...
export default function GeneratingScreen() {
  ...
  useEffect(() => {
    // Non-linear progress: 0→25% fast, 25→60% medium, 60→85% slow, holds
    Animated.sequence([
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.appBackground, paddingTop: insets.top }]}>
      ...
      <View style={styles.animCenter}>
        {/* Orbiting dots */}
        <View style={[styles.orbitContainer, { width: (ORBIT_RADIUS + DOT_SIZE) * 2, height: (ORBIT_RADIUS + DOT_SIZE) * 2, borderRadius: (ORBIT_RADIUS + DOT_SIZE) }]}>
